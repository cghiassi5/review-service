/* this file is used to create sample houses which are added to a csv to later be stored in database */
...
const csvWriter = createCsvWriter({
  path: path.join(__dirname, '/data_generation/houses', 'house.csv'),
  header: houseHeader,
  alwaysQuote: true,
});
